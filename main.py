...
class MainEngine(object):
    ...
    def __initResource(self):
        ...
        self.wSprites = dict(getready=PhotoImage(file="resource/sprite_get_ready.png"),
                             ...
                             pellet=PhotoImage(file="resource/sprite_pellet.png"),start=PhotoImage(file="resource/start_screen.png"))
        #self.wSprites2 = dict(wall2=PhotoImage(file="resource/start_screen.jpg"))
    ...
    def __initWidgets(self):
        ...
        self.wLvLabel = Label(self.root, text="Select the level (1-8).")
        self.wLvLabel2 = Label(self.root, text="Stage 8 is insane")
        self.wLvLabel3 = Label(self.root, image=self.wSprites['wall'])
        self.wLvLabel4 = Label(self.root, image=self.wSprites['start'])
        #self.wLvlLabel5 = Label(self.root.i)
        #self.wLvLabel3 = Label(self.root, image="resource/start_screen.jpg")
        self.wLvEntry = Entry(self.root)
        self.wLvBtn = Button(self.root, text="Select", command=self.lvSelect, width=5, height=1)
        self.wLvBtn2 = Button(self.root, image=self.wSprites['ghost{}L1'.format(1)])
        self.wLvBtn3 = Button(self.root, image=self.wSprites['ghost{}R2'.format(2)])
        self.wLvBtn4 = Button(self.root, image=self.wSprites['ghost{}U2'.format(3)])
        self.wLvBtn5 = Button(self.root, image=self.wSprites['ghost{}D1'.format(4)])
        self.wLvLabel5 = Label(self.root, text="Introducing Ghosts, the red one is the most violent one, be careful!")
        ...
        self.wGameCanvMovingObjects = [self.wGameCanv.create_image(0,0,image=None) for n in range(7)] # 0: pacman, 1-4: ghosts
